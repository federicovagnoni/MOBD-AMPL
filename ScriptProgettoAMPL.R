...
#data_por_final <- mutate(data_por_final, GP = ifelse(school == "GP", 1, -1))
#data_por_final <- mutate(data_por_final, MS = ifelse(school == "MS", 1, -1))
data_por_final <- mutate(data_por_final, school = NULL)
#data_por_final <- mutate(data_por_final, M = ifelse(sex == "M", 1, -1))
#data_por_final <- mutate(data_por_final, F = ifelse(sex == "F", 1, -1))
data_por_final <- mutate(data_por_final, sex = NULL)
#data_por_final <- mutate(data_por_final, address_U = ifelse(address == "U", 1, -1))
#data_por_final <- mutate(data_por_final, address_R = ifelse(address == "R", 1, -1))
data_por_final <- mutate(data_por_final, address = NULL)
data_por_final <- mutate(data_por_final, Pstatus_T = ifelse(Pstatus == "T", 1, -1))
data_por_final <- mutate(data_por_final, Pstatus_A = ifelse(Pstatus == "A", 1, -1))
...
data_por_final <- mutate(data_por_final, famsup = ifelse(famsup == "yes", 1, -1))
data_por_final <- mutate(data_por_final, activities = ifelse(activities == "yes", 1, -1))
data_por_final <- mutate(data_por_final, paid = ifelse(paid == "yes", 1, -1))
data_por_final <- mutate(data_por_final, internet = ifelse(internet == "yes", 1, -1))
data_por_final <- mutate(data_por_final, nursery = ifelse(nursery == "yes", 1, -1))
data_por_final <- mutate(data_por_final, higher = ifelse(higher == "yes", 1, -1))
data_por_final <- mutate(data_por_final, romantic = ifelse(romantic == "yes", 1, -1))

#data_por_final <- mutate(data_por_final, Mjob_at_home = ifelse(Mjob == "at-home", 1, -1))
#data_por_final <- mutate(data_por_final, Fjob_at_home = ifelse(Fjob == "at-home", 1, -1))
#data_por_final <- mutate(data_por_final, Mjob_health = ifelse(Mjob == "health", 1, -1))
#data_por_final <- mutate(data_por_final, Fjob_health = ifelse(Fjob == "health", 1, -1))
#data_por_final <- mutate(data_por_final, Mjob_services = ifelse(Mjob == "services", 1, -1))
#data_por_final <- mutate(data_por_final, Fjob_services = ifelse(Fjob == "services", 1, -1))
#data_por_final <- mutate(data_por_final, Mjob_teacher = ifelse(Mjob == "teacher", 1, -1))
#data_por_final <- mutate(data_por_final, Fjob_teacher = ifelse(Fjob == "teacher", 1, -1))
#data_por_final <- mutate(data_por_final, Mjob_other = ifelse(Mjob == "other", 1, -1))
#data_por_final <- mutate(data_por_final, Fjob_other = ifelse(Fjob == "other", 1, -1))
